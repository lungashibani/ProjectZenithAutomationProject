Feature: •	Create Candidate Record – Link Employer Only Organisation
  ...
  Scenario: Successful Login with Valid Credentials
    ...
    When User looks up for Organisation Menu
    Then User selects desired an Organisation Menu Item
    And User enters nothing onLocation to validate if message
